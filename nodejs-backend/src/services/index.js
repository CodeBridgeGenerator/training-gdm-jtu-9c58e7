...
const kelulusan = require("./kelulusan/kelulusan.service.js");
const dokumen = require("./dokumen/dokumen.service.js");
const latihan = require("./latihan/latihan.service.js");
const calon = require("./calon/calon.service.js");
...
module.exports = function (app) {
  ...
  app.configure(kelulusan);
  app.configure(dokumen);
  app.configure(latihan);
  app.configure(calon);
