...
const SingleKelulusanPage = (props) => {
    ...
    return (
        ...
        <div className="col-12 flex flex-column align-items-center">
            ...
            <div className="col-12 md:col-6 lg:col-3"><label className="text-sm text-primary">Latihan</label><p className="m-0 ml-3" >{_entity?.latihan}</p></div>
<div className="col-12 md:col-6 lg:col-3"><label className="text-sm text-primary">pelulus</label><p className="m-0 ml-3" >{_entity?.pelulus}</p></div>
