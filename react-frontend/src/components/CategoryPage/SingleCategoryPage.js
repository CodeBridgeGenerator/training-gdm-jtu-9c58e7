...
const SingleCategoryPage = (props) => {
    ...
    useEffect(() => {
        ...
        client
            .service("category")
            .get(urlParams.singleCategoryId, { query: { $populate: [            {
                path: "createdBy",
                service: "users",
                select: ["name"],
              },{
    ...
    }, [props,urlParams.singleCategoryId]);
    ...
    return (
        ...
        <div className="col-12 flex flex-column align-items-center">
            <div className="col-10">
                ...
                <p>category/{urlParams.singleCategoryId}</p>
...
export default connect(mapState, mapDispatch)(SingleCategoryPage);
