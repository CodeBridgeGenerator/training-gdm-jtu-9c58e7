...
import SingleKelulusanPage from "../components/KelulusanPage/SingleKelulusanPage";
import KelulusanProjectLayoutPage from "../components/KelulusanPage/KelulusanProjectLayoutPage";
import SingleDokumenPage from "../components/DokumenPage/SingleDokumenPage";
import DokumanProjectLayoutPage from "../components/DokumenPage/DokumanProjectLayoutPage";
import SingleLatihanPage from "../components/LatihanPage/SingleLatihanPage";
import LatihanProjectLayoutPage from "../components/LatihanPage/LatihanProjectLayoutPage";
import SingleCalonPage from "../components/CalonPage/SingleCalonPage";
import CalonProjectLayoutPage from "../components/CalonPage/CalonProjectLayoutPage";
import SingleCategoryPage from "../components/CategoryPage/SingleCategoryPage";
import CategoryProjectLayoutPage from "../components/CategoryPage/CategoryProjectLayoutPage";
import SingleNotifyPage from "../components/NotifyPage/SingleNotifyPage";
import NotifyProjectLayoutPage from "../components/NotifyPage/NotifyProjectLayoutPage";
// ~cb-add-import~
...
<Route path="/kelulusan/:singleKelulusanId" exact element={<SingleKelulusanPage />} />
<Route path="/kelulusan" exact element={<KelulusanProjectLayoutPage />} />
<Route path="/dokumen/:singleDokumenId" exact element={<SingleDokumenPage />} />
<Route path="/dokumen" exact element={<DokumanProjectLayoutPage />} />
<Route path="/latihan/:singleLatihanId" exact element={<SingleLatihanPage />} />
<Route path="/latihan" exact element={<LatihanProjectLayoutPage />} />
<Route path="/calon/:singleCalonId" exact element={<SingleCalonPage />} />
<Route path="/calon" exact element={<CalonProjectLayoutPage />} />
...
<Route path="/notify/:singleNotifyId" exact element={<SingleNotifyPage />} />
<Route path="/notify" exact element={<NotifyProjectLayoutPage />} />
